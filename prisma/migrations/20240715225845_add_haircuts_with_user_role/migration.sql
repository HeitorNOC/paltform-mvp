...
CREATE TABLE "Haircut" (
    ...
    CONSTRAINT "Haircut_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "Haircut_userId_idx" ON "Haircut"("userId");
